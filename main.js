...
//if play button is clicked then game is reset
...
class Food extends Phaser.GameObjects.Image {
  constructor(scene, x, y) {
    ...
    this.fruitTypes = ["apple", "banana", "grape"];
  ...
  reposition() {
    ...
    this.currentFruitIndex = (this.currentFruitIndex + 1) % this.fruitTypes.length;
    this.setTexture(this.fruitTypes[this.currentFruitIndex]);
